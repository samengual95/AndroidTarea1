...
import com.tecnoinfsanjose.tareaandroiduno.Controladores.Adaptador;
...
public class ListaUsuarios extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        atras = view.findViewById(R.id.imageButton4);
        ...
        items = view.findViewById(R.id.lvUsuario);
        adaptador = new Adaptador(getActivity(),clienteControlador.darClientes());
